...
# def preprocess_data(raw_df, scaler_numeric: bool = False):
...
# def preprocess_new_data(new_df, input_cols, scaler, encoder, scaler_numeric: bool = False):
...
#     if scale_numeric and scaler is not None: inputs[numeric_cols] = scaler.transform(inputs[numeric_cols])
